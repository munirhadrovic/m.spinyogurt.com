...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            ...
            <h1 style="color:black";>Powered by <a href="http://mobilegrows.com/" rel="external">MobileGrows </a>|<a href="http://www.spinyogurt.com/" rel="external"> DesktopSite</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<fieldset class="ui-grid-a" data-theme="<?php echo $theme ?>">
					...
					<div class="ui-block-a"><a class="findus ui-btn ui-icon-phone ui-btn-icon-left buttons-radius" href="tel:<?php echo $telephone ?>">Call US</a></div>
					...
					<div class="ui-block-b" id="findUS">
						<script>
							...
							if(/Android|webOS|Opera Mini/i.test(navigator.userAgent) ) {
								...
								dugme.setAttribute('class', "findus ui-btn ui-icon-location ui-btn-icon-left buttons-radius");
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#page2" data-transition="<?php echo $transitionefect ?>">FLAVORS</a>
					</div>
				</div>
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu">
						<ul id="menu">
							...
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">FLAVORS</a></li>
							<li><a href="#page2" data-transition="<?php echo $transitionefect ?>">Q & A</a></li>
                            <li><a href="#page2" data-transition="<?php echo $transitionefect ?>">GIFT CARDS</a></li>
